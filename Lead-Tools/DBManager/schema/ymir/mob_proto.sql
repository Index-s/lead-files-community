...
--
-- Host: 202.31.212.73    Database: ymir_player
-- ------------------------------------------------------
...
CREATE TABLE `mob_proto` (
  ...
  `skill_level0` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `skill_vnum0` int(10) unsigned NOT NULL DEFAULT '0',
  `skill_level1` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `skill_vnum1` int(10) unsigned NOT NULL DEFAULT '0',
  `skill_level2` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `skill_vnum2` int(10) unsigned NOT NULL DEFAULT '0',
  `skill_level3` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `skill_vnum3` int(10) unsigned NOT NULL DEFAULT '0',
  `skill_level4` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `skill_vnum4` int(10) unsigned NOT NULL DEFAULT '0',
