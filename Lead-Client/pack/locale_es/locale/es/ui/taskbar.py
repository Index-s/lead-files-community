			...
			(
				{
					...
					"images" :
					(
						"locale/es/ui/Mall/00.sub",
						"locale/es/ui/Mall/01.sub",
						"locale/es/ui/Mall/02.sub",
						"locale/es/ui/Mall/03.sub",
						"locale/es/ui/Mall/04.sub",
						"locale/es/ui/Mall/05.sub",
						"locale/es/ui/Mall/06.sub",
						"locale/es/ui/Mall/07.sub",
						"locale/es/ui/Mall/08.sub",
						"locale/es/ui/Mall/09.sub",
						"locale/es/ui/Mall/11.sub",
						"locale/es/ui/Mall/12.sub",
						"locale/es/ui/Mall/13.sub",
						"locale/es/ui/Mall/14.sub",
						"locale/es/ui/Mall/15.sub",
						"locale/es/ui/Mall/16.sub",
					)
				},
				{
					"name" : "RampageGauge2",
