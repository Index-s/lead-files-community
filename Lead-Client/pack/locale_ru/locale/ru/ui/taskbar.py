			...
			(
				{
					...
					"images" :
					(
						"locale/ru/ui/Mall/00.sub",
						"locale/ru/ui/Mall/01.sub",
						"locale/ru/ui/Mall/02.sub",
						"locale/ru/ui/Mall/03.sub",
						"locale/ru/ui/Mall/04.sub",
						"locale/ru/ui/Mall/05.sub",
						"locale/ru/ui/Mall/06.sub",
						"locale/ru/ui/Mall/07.sub",
						"locale/ru/ui/Mall/08.sub",
						"locale/ru/ui/Mall/09.sub",
						"locale/ru/ui/Mall/11.sub",
						"locale/ru/ui/Mall/12.sub",
						"locale/ru/ui/Mall/13.sub",
						"locale/ru/ui/Mall/14.sub",
						"locale/ru/ui/Mall/15.sub",
						"locale/ru/ui/Mall/16.sub",
					)
				},
				{
					"name" : "RampageGauge2",
