...
void CTerrainPatch::SoftwareTransformPatch_UpdateTerrainLighting(DWORD_PTR dwVersion, const D3DLIGHT9& c_rkLight, const D3DMATERIAL9& c_rkMtrl)
{
...
void CTerrainPatchProxy::SoftwareTransformPatch_UpdateTerrainLighting(DWORD_PTR dwVersion, const D3DLIGHT9& c_rkLight, const D3DMATERIAL9& c_rkMtrl)
{
	if (m_pTerrainPatch)
