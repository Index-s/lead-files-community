...
void CScreen::RenderBox3d(float sx, float sy, float sz, float ex, float ey, float ez)
{
	...
	SPDTVertexRaw vertices[8] =
	{
		...
		{ sx, ey, ez, ms_diffuseColor, 0.0f, 0.0f },	// 2
		{ ex+1.0f, ey, ez, ms_diffuseColor, 0.0f, 0.0f }	// 3, (3 with x increased by 1)
	};
...
// // Donghyun added on September 9, 2003
// // Stupid thing for terrain picking... ㅡㅡ; Need to integrate with the above...
