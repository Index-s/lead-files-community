...
// ***********************************************
 ...
 __declspec(dllimport) void _stdcall VMStart(void);

 __declspec(dllimport) void _stdcall VMEnd(void);

 __declspec(dllimport) void _stdcall CodeReplaceStart(void);

 __declspec(dllimport) void _stdcall CodeReplaceEnd(void);

 __declspec(dllimport) void _stdcall RegisteredStart(void);

 __declspec(dllimport) void _stdcall RegisteredEnd(void);

 __declspec(dllimport) void _stdcall EncodeStart(void);

 __declspec(dllimport) void _stdcall EncodeEnd(void);

 __declspec(dllimport) void _stdcall ClearStart(void);

 __declspec(dllimport) void _stdcall ClearEnd(void);

 __declspec(dllimport) void _stdcall MutateStart(void);

 __declspec(dllimport) void _stdcall MutateEnd(void);

 __declspec(dllimport) void _stdcall StrEncryptStart(void);

 __declspec(dllimport) void _stdcall StrEncryptEnd(void);

 __declspec(dllimport) void _stdcall StrEncryptWStart(void);

 __declspec(dllimport) void _stdcall StrEncryptWEnd(void);

 __declspec(dllimport) void _stdcall UnregisteredStart(void);

 __declspec(dllimport) void _stdcall UnregisteredEnd(void);

 __declspec(dllimport) void _stdcall RegisteredVMStart(void);

 __declspec(dllimport) void _stdcall RegisteredVMEnd(void);

 __declspec(dllimport) void _stdcall UnprotectedStart(void);

 __declspec(dllimport) void _stdcall UnprotectedEnd(void);

 __declspec(dllimport) void _stdcall SECheckProtection(int *user_var, int user_value);

 __declspec(dllimport) void _stdcall SECheckCodeIntegrity(int *user_var, int user_value);

 __declspec(dllimport) void _stdcall SECheckRegistration(int *user_var, int user_value);
...
// ***********************************************
 ...
 #define VM_REGISTEREDVM_START RegisteredVMStart();
 #define VM_REGISTEREDVM_END RegisteredVMEnd();
