...
#define MILESVERSIONDATE  "12-Dec-12"
#define MILESCOPYRIGHT    "Copyright (C) 1991-2012, RAD Game Tools, Inc."
...
#elif defined(IS_PS3) || defined(IS_WII) || defined(IS_WIIU) || defined(__RADSEKRIT__) || defined(__RADSEKRIT2__)
...
typedef struct _SAMPLE             // Sample instance
{
   ...
   F32      low_pass_cutoff[MAX_SPEAKERS];
...
#if defined(IS_PSP2) || defined(IS_PSP) || defined(IS_XENON) || defined(IS_IPHONE) || defined(IS_MAC) || defined(IS_LINUX) || defined(IS_3DS) || defined(IS_WIIU) || defined(__RADSEKRIT__) || defined(__RADSEKRIT2__) || defined(__RADANDROID__) // generic dig platforms
...
#if defined(IS_MAC) || defined(IS_LINUX) || defined(IS_XENON) || defined(IS_PS3) || defined(IS_WII) || defined(IS_PSP) || defined(IS_PSP2) || defined(__RADSEKRIT__) || defined(__RADSEKRIT2__) || defined(__RADANDROID__)
...
#if defined(IS_XENON) || defined(IS_WII) || defined(IS_PS3) || defined(IS_PSP) || defined(IS_3DS) || defined(IS_IPHONE) || defined(IS_PSP2) || defined(IS_WIIU) || defined(__RADSEKRIT__) || defined(__RADSEKRIT2__) || defined(__RADANDROID__)
...
DXDEC S32     AILCALL
#if defined(IS_WINDOWS) || defined(IS_MAC) || defined(IS_LINUX) || defined(IS_XENON) || defined(IS_PS3) || defined(IS_WII) || defined(__RADSEKRIT__) || defined(__RADSEKRIT2__) || defined(__RADANDROID__)
                       AIL_quick_startup           (
#else
