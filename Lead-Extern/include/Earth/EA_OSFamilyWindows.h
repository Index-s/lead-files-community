/**
 * @file	EA_OSFamilyWindows.h
 * @brief	Galaxy platform-related header file
 * @author	Standil (cpascal@cpascal.net)
 *
 * @version	2008/04/24 cpascal - First release
 */

#ifndef _EA_OSFAMILYWINDOWS_H_
#define _EA_OSFAMILYWINDOWS_H_
