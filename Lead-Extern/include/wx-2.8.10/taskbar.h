...
// ----------------------------------------------------------------------------
    ...
    #include "wx-2.8.10/palmos/taskbar.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/taskbar.h"
#elif defined(__WXGTK__) || defined(__WXX11__) || defined(__WXMOTIF__)
    #include "wx-2.8.10/unix/taskbarx11.h"
#elif defined (__WXMAC__) && defined(__WXMAC_OSX__)
    #include "wx-2.8.10/mac/taskbarosx.h"
#elif defined (__WXCOCOA__)
    #include "wx-2.8.10/cocoa/taskbar.h"
#endif
