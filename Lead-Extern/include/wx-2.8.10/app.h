...
#include "wx-2.8.10/event.h"       // for the base class
#include "wx-2.8.10/build.h"
#include "wx-2.8.10/init.h"        // we must declare wxEntry()
...
// ----------------------------------------------------------------------------
        ...
        #include "wx-2.8.10/palmos/app.h"
    #elif defined(__WXMSW__)
        #include "wx-2.8.10/msw/app.h"
    #elif defined(__WXMOTIF__)
        #include "wx-2.8.10/motif/app.h"
    #elif defined(__WXMGL__)
        #include "wx-2.8.10/mgl/app.h"
    #elif defined(__WXDFB__)
        #include "wx-2.8.10/dfb/app.h"
    #elif defined(__WXGTK20__)
        #include "wx-2.8.10/gtk/app.h"
    #elif defined(__WXGTK__)
        #include "wx-2.8.10/gtk1/app.h"
    #elif defined(__WXX11__)
        #include "wx-2.8.10/x11/app.h"
    #elif defined(__WXMAC__)
        #include "wx-2.8.10/mac/app.h"
    #elif defined(__WXCOCOA__)
        #include "wx-2.8.10/cocoa/app.h"
    #elif defined(__WXPM__)
        #include "wx-2.8.10/os2/app.h"
    #endif
#else // !GUI
...
// port-specific header could have defined it already in some special way
    ...
    #include "wx-2.8.10/univ/theme.h"
