...
#include "wx-2.8.10/list.h"        // for "template" list classes
#include "wx-2.8.10/window.h"      // base class for wxMenuBar
...
// ----------------------------------------------------------------------------
    ...
    #include "wx-2.8.10/univ/menu.h"
#elif defined(__WXPALMOS__)
    #include "wx-2.8.10/palmos/menu.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/menu.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/menu.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/menu.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/menu.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/menu.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/menu.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/menu.h"
#endif
