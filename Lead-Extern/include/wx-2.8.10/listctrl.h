...
#include "wx-2.8.10/defs.h" // headers should include this before first wxUSE_XXX check

#if wxUSE_LISTCTRL

#include "wx-2.8.10/listbase.h"
...
// ----------------------------------------------------------------------------
    ...
    #include "wx-2.8.10/msw/listctrl.h"
#elif defined(__WXMAC__) && !defined(__WXUNIVERSAL__)
    #include "wx-2.8.10/mac/carbon/listctrl.h"
#else
    #include "wx-2.8.10/generic/listctrl.h"
#endif
