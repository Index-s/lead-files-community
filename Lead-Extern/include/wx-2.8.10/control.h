...
#include "wx-2.8.10/window.h"      // base class
...
// ----------------------------------------------------------------------------
    ...
    #include "wx-2.8.10/univ/control.h"
#elif defined(__WXPALMOS__)
    #include "wx-2.8.10/palmos/control.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/control.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/control.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/control.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/control.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/control.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/control.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/control.h"
#endif
