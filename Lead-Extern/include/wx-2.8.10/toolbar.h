...
#if wxUSE_TOOLBAR
    #include "wx-2.8.10/tbarbase.h"     // the base class for all toolbars

    #if defined(__WXUNIVERSAL__)
       #include "wx-2.8.10/univ/toolbar.h"
    #elif defined(__WXPALMOS__)
       #include "wx-2.8.10/palmos/toolbar.h"
    #elif defined(__WXMSW__) && (!defined(_WIN32_WCE) || (_WIN32_WCE >= 400 && !defined(__POCKETPC__) && !defined(__SMARTPHONE__)))
       #include "wx-2.8.10/msw/tbar95.h"
    #elif defined(__WXWINCE__)
       #include "wx-2.8.10/msw/wince/tbarwce.h"
    #elif defined(__WXMOTIF__)
       #include "wx-2.8.10/motif/toolbar.h"
    #elif defined(__WXGTK20__)
        #include "wx-2.8.10/gtk/tbargtk.h"
    #elif defined(__WXGTK__)
        #include "wx-2.8.10/gtk1/tbargtk.h"
    #elif defined(__WXMAC__)
       #include "wx-2.8.10/mac/toolbar.h"
    #elif defined(__WXCOCOA__)
       #include "wx-2.8.10/cocoa/toolbar.h"
    #elif defined(__WXPM__)
       #include "wx-2.8.10/os2/toolbar.h"
    #endif
#endif // wxUSE_TOOLBAR
