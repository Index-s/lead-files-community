...
// ABX: check __WIN32__ instead of __WXMSW__ for the same MSWBase in any Win32 port
    ...
    #include "wx-2.8.10/palmos/apptbase.h"
#elif defined(__WIN32__)
    #include "wx-2.8.10/msw/apptbase.h"
#elif defined(__UNIX__) && !defined(__EMX__)
    #include "wx-2.8.10/unix/apptbase.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/apptbase.h"
#elif defined(__OS2__)
    #include "wx-2.8.10/os2/apptbase.h"
...
// ABX: check __WIN32__ instead of __WXMSW__ for the same MSWBase in any Win32 port
#if defined(__WXPALMOS__)
    #include "wx-2.8.10/palmos/apptrait.h"
#elif defined(__WIN32__)
    #include "wx-2.8.10/msw/apptrait.h"
#elif defined(__OS2__)
    #include "wx-2.8.10/os2/apptrait.h"
#elif defined(__UNIX__)
    #include "wx-2.8.10/unix/apptrait.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/apptrait.h"
#elif defined(__DOS__)
    #include "wx-2.8.10/msdos/apptrait.h"
#else
    #if wxUSE_GUI
