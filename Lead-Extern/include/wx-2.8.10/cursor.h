...
#include "wx-2.8.10/defs.h"
    ...
    #include "wx-2.8.10/palmos/cursor.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/cursor.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/cursor.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/cursor.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/cursor.h"
#elif defined(__WXX11__)
    #include "wx-2.8.10/x11/cursor.h"
#elif defined(__WXMGL__)
    #include "wx-2.8.10/mgl/cursor.h"
#elif defined(__WXDFB__)
    #include "wx-2.8.10/dfb/cursor.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/cursor.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/cursor.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/cursor.h"
#endif
