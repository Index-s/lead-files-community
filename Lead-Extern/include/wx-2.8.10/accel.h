...
// ----------------------------------------------------------------------------
    ...
    #include "wx-2.8.10/generic/accel.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/accel.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/accel.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/accel.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/accel.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/accel.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/generic/accel.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/accel.h"
#endif
