...
// Universal and non-port related switches with need for generic implementation
    ...
    #include "wx-2.8.10/generic/dirdlgg.h"
    ...
    #include "wx-2.8.10/generic/dirdlgg.h"     // MS PocketPC or MS Smartphone
    #define wxDirDialog wxGenericDirDialog
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/dirdlg.h"  // Native MSW
#elif defined(__WXGTK24__)
    #include "wx-2.8.10/gtk/dirdlg.h"  // Native GTK for gtk2.4
#elif defined(__WXGTK__)
    #include "wx-2.8.10/generic/dirdlgg.h"
    #define wxDirDialog wxGenericDirDialog
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/dirdlg.h"      // Native Mac
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/dirdlg.h"    // Native Cocoa
#elif defined(__WXMOTIF__) || \
      defined(__WXX11__)   || \
      defined(__WXMGL__)   || \
      defined(__WXCOCOA__) || \
      defined(__WXPM__)
    #include "wx-2.8.10/generic/dirdlgg.h"     // Other ports use generic implementation
    #define wxDirDialog wxGenericDirDialog
#endif
