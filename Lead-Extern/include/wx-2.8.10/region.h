...
#if defined(__WXPALMOS__)
    #include "wx-2.8.10/palmos/region.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/region.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/region.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/region.h"
#elif defined(__WXMOTIF__) || defined(__WXX11__)
    #include "wx-2.8.10/x11/region.h"
#elif defined(__WXMGL__)
    #include "wx-2.8.10/mgl/region.h"
#elif defined(__WXDFB__)
    #include "wx-2.8.10/dfb/region.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/region.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/region.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/region.h"
#endif
