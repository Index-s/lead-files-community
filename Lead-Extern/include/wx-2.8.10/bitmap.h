...
#include "wx-2.8.10/gdicmn.h"  // for wxBitmapType
...
protected:
    ...
    #include "wx-2.8.10/palmos/bitmap.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/bitmap.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/x11/bitmap.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/bitmap.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/bitmap.h"
#elif defined(__WXX11__)
    #include "wx-2.8.10/x11/bitmap.h"
#elif defined(__WXMGL__)
    #include "wx-2.8.10/mgl/bitmap.h"
#elif defined(__WXDFB__)
    #include "wx-2.8.10/dfb/bitmap.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/bitmap.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/bitmap.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/bitmap.h"
#endif
...
// we must include generic mask.h after wxBitmap definition
    ...
    #include "wx-2.8.10/generic/mask.h"
#endif
