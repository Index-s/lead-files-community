...
// ----------------------------------------------------------------------------
    ...
    #include "wx-2.8.10/univ/spinbutt.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/spinbutt.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/spinbutt.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/spinbutt.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/spinbutt.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/spinbutt.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/spinbutt.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/spinbutt.h"
#endif
