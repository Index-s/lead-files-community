...
private:
    ...
    #include "wx-2.8.10/univ/checkbox.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/checkbox.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/checkbox.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/checkbox.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/checkbox.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/checkbox.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/checkbox.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/checkbox.h"
#elif defined(__WXPALMOS__)
    #include "wx-2.8.10/palmos/checkbox.h"
#endif
