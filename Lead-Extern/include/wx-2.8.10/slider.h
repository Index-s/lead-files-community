...
// ----------------------------------------------------------------------------
    ...
    #include "wx-2.8.10/univ/slider.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/slider95.h"
    #if WXWIN_COMPATIBILITY_2_4
         #define wxSlider95 wxSlider
    #endif
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/slider.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/slider.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/slider.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/slider.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/slider.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/slider.h"
#elif defined(__WXPALMOS__)
    #include "wx-2.8.10/palmos/slider.h"
#endif
