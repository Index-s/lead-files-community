...
#include "wx-2.8.10/ctrlsub.h"         // base class
...
// ----------------------------------------------------------------------------
    ...
    #include "wx-2.8.10/univ/listbox.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/listbox.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/listbox.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/listbox.h"
#elif defined(__WXGTK__)
  #include "wx-2.8.10/gtk1/listbox.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/listbox.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/listbox.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/listbox.h"
#endif
