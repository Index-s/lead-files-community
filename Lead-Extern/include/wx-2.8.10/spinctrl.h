...
#include "wx-2.8.10/spinbutt.h"        // should make wxSpinEvent visible to the app
...
// ----------------------------------------------------------------------------
    ...
    #include "wx-2.8.10/generic/spinctlg.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/spinctrl.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/spinctrl.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/spinctrl.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/spinctrl.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/generic/spinctlg.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/spinctrl.h"
