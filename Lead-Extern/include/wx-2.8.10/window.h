...
#include "wx-2.8.10/event.h"           // the base class

#include "wx-2.8.10/list.h"            // defines wxWindowList

#include "wx-2.8.10/cursor.h"          // we have member variables of these classes
#include "wx-2.8.10/font.h"            // so we can't do without them
#include "wx-2.8.10/colour.h"
#include "wx-2.8.10/region.h"
#include "wx-2.8.10/utils.h"
#include "wx-2.8.10/intl.h"

#include "wx-2.8.10/validate.h"        // for wxDefaultValidator (always include it)
...
#if wxUSE_ACCEL
    #include "wx-2.8.10/accel.h"
#endif // wxUSE_ACCEL

#if wxUSE_ACCESSIBILITY
#include "wx-2.8.10/access.h"
#endif
...
// include the declaration of the platform-specific class
    ...
    #endif // wxUniv/!wxUniv
    #include "wx-2.8.10/palmos/window.h"
    ...
    #endif // wxUniv/!wxUniv
    #include "wx-2.8.10/msw/window.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/window.h"
    ...
    #endif // wxUniv
    #include "wx-2.8.10/gtk/window.h"
        ...
        #define wxWindowGTK wxWindow
    #endif // wxUniv
    #include "wx-2.8.10/gtk1/window.h"
    ...
    #endif // wxUniv
    #include "wx-2.8.10/x11/window.h"
#elif defined(__WXMGL__)
    #define wxWindowNative wxWindowMGL
    #include "wx-2.8.10/mgl/window.h"
#elif defined(__WXDFB__)
    #define wxWindowNative wxWindowDFB
    #include "wx-2.8.10/dfb/window.h"
    ...
    #endif // wxUniv
    #include "wx-2.8.10/mac/window.h"
    ...
    #endif // wxUniv
    #include "wx-2.8.10/cocoa/window.h"
    ...
    #endif // wxUniv/!wxUniv
    #include "wx-2.8.10/os2/window.h"
#endif
...
// for the native ports we already have defined it above
    ...
    #include "wx-2.8.10/univ/window.h"
#endif // wxUniv
