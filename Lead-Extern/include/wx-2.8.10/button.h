...
protected:
    ...
    #include "wx-2.8.10/univ/button.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/button.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/button.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/button.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/button.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/button.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/button.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/button.h"
#elif defined(__WXPALMOS__)
    #include "wx-2.8.10/palmos/button.h"
#endif
