...
#include "wx-2.8.10/treebase.h"
#include "wx-2.8.10/textctrl.h" // wxTextCtrl::ms_classinfo used through CLASSINFO macro
...
// ----------------------------------------------------------------------------
    ...
    #include "wx-2.8.10/generic/treectlg.h"
#elif defined(__WXPALMOS__)
    #include "wx-2.8.10/palmos/treectrl.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/treectrl.h"
