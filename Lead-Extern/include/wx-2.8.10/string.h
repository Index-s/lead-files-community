...
#include "wx-2.8.10/defs.h"        // everybody should include this
...
#include "wx-2.8.10/wxchar.h"      // for wxChar
#include "wx-2.8.10/buffer.h"      // for wxCharBuffer
#include "wx-2.8.10/strconv.h"     // for wxConvertXXX() macros and wxMBConv classes
...
#include "wx-2.8.10/beforestd.h"
#include <string>
#include "wx-2.8.10/afterstd.h"
