...
protected:
    ...
    #include "wx-2.8.10/generic/colour.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/colour.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/colour.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/colour.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/colour.h"
#elif defined(__WXMGL__)
    #include "wx-2.8.10/generic/colour.h"
#elif defined(__WXDFB__)
    #include "wx-2.8.10/generic/colour.h"
#elif defined(__WXX11__)
    #include "wx-2.8.10/x11/colour.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/colour.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/colour.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/colour.h"
#endif
