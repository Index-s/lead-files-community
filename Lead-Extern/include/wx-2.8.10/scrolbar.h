...
private:
    ...
    #include "wx-2.8.10/univ/scrolbar.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/scrolbar.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/scrolbar.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/scrolbar.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/scrolbar.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/scrolbar.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/scrolbar.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/scrolbar.h"
#endif
