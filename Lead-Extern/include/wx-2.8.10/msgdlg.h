...
#include "wx-2.8.10/generic/msgdlgg.h"
#elif defined(__WXUNIVERSAL__) || defined(__WXGPE__)
#include "wx-2.8.10/generic/msgdlgg.h"
#elif defined(__WXPALMOS__)
#include "wx-2.8.10/palmos/msgdlg.h"
#elif defined(__WXMSW__)
#include "wx-2.8.10/msw/msgdlg.h"
#elif defined(__WXMOTIF__)
#include "wx-2.8.10/motif/msgdlg.h"
#elif defined(__WXGTK20__)
#include "wx-2.8.10/gtk/msgdlg.h"
#elif defined(__WXGTK__)
#include "wx-2.8.10/generic/msgdlgg.h"
#elif defined(__WXGTK__)
#include "wx-2.8.10/generic/msgdlgg.h"
#elif defined(__WXMAC__)
#include "wx-2.8.10/mac/msgdlg.h"
#elif defined(__WXCOCOA__)
#include "wx-2.8.10/cocoa/msgdlg.h"
#elif defined(__WXPM__)
#include "wx-2.8.10/os2/msgdlg.h"
#endif
