...
#define wxMakeMetaFilePlaceable wxMakeMetafilePlaceable
            ...
            #include "wx-2.8.10/palmos/enhmeta.h"
        #else
            #include "wx-2.8.10/msw/enhmeta.h"
        #endif

        #if wxUSE_WIN_METAFILES_ALWAYS
            // use normal metafiles as well
            #include "wx-2.8.10/msw/metafile.h"
        ...
        #if defined(__WXPALMOS__)
            #include "wx-2.8.10/palmos/metafile.h"
        #else
            #include "wx-2.8.10/msw/metafile.h"
        #endif
    #endif
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/metafile.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/metafile.h"
#endif
