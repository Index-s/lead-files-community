...
// ----------------------------------------------------------------------------
    ...
    #include "wx-2.8.10/msw/ole/dropsrc.h"
    #include "wx-2.8.10/msw/ole/droptgt.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/dnd.h"
#elif defined(__WXX11__)
    #include "wx-2.8.10/x11/dnd.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/dnd.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/dnd.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/dnd.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/dnd.h"
#endif
