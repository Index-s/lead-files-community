...
#include "wx-2.8.10/renderer.h" // this is needed for wxCONTROL_XXX flags
#include "wx-2.8.10/bitmap.h" // wxBitmap used by-value
...
// ----------------------------------------------------------------------------
    ...
    #include "wx-2.8.10/msw/combo.h"
#endif

// Any ports may need generic as an alternative
#include "wx-2.8.10/generic/combo.h"
