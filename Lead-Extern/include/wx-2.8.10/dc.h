...
#include "wx-2.8.10/object.h"          // the base class

#include "wx-2.8.10/intl.h"            // for wxLayoutDirection
...
#include "wx-2.8.10/bitmap.h"          // for wxNullBitmap
#include "wx-2.8.10/brush.h"
#include "wx-2.8.10/pen.h"
#include "wx-2.8.10/palette.h"
#include "wx-2.8.10/list.h"            // we use wxList in inline functions
...
// ----------------------------------------------------------------------------
    ...
    #include "wx-2.8.10/palmos/dc.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/dc.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/dc.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/dc.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/dc.h"
#elif defined(__WXX11__)
    #include "wx-2.8.10/x11/dc.h"
#elif defined(__WXMGL__)
    #include "wx-2.8.10/mgl/dc.h"
#elif defined(__WXDFB__)
    #include "wx-2.8.10/dfb/dc.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/dc.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/dc.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/dc.h"
#endif

#if wxUSE_GRAPHICS_CONTEXT
    #include "wx-2.8.10/dcgraph.h"
#endif
