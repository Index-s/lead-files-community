...
private:
    ...
    #include "wx-2.8.10/univ/dialog.h"
#else
    #if defined(__WXPALMOS__)
        #include "wx-2.8.10/palmos/dialog.h"
    #elif defined(__WXMSW__)
        #include "wx-2.8.10/msw/dialog.h"
    #elif defined(__WXMOTIF__)
        #include "wx-2.8.10/motif/dialog.h"
    #elif defined(__WXGTK20__)
        #include "wx-2.8.10/gtk/dialog.h"
    #elif defined(__WXGTK__)
        #include "wx-2.8.10/gtk1/dialog.h"
    #elif defined(__WXMAC__)
        #include "wx-2.8.10/mac/dialog.h"
    #elif defined(__WXCOCOA__)
        #include "wx-2.8.10/cocoa/dialog.h"
    #elif defined(__WXPM__)
        #include "wx-2.8.10/os2/dialog.h"
    #endif
#endif
