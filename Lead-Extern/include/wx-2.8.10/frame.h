...
#include "wx-2.8.10/toplevel.h"      // the base class
...
// include the real class declaration
    ...
    #include "wx-2.8.10/univ/frame.h"
#else // !__WXUNIVERSAL__
    #if defined(__WXPALMOS__)
        #include "wx-2.8.10/palmos/frame.h"
    #elif defined(__WXMSW__)
        #include "wx-2.8.10/msw/frame.h"
    #elif defined(__WXGTK20__)
        #include "wx-2.8.10/gtk/frame.h"
    #elif defined(__WXGTK__)
        #include "wx-2.8.10/gtk1/frame.h"
    #elif defined(__WXMOTIF__)
        #include "wx-2.8.10/motif/frame.h"
    #elif defined(__WXMAC__)
        #include "wx-2.8.10/mac/frame.h"
    #elif defined(__WXCOCOA__)
        #include "wx-2.8.10/cocoa/frame.h"
    #elif defined(__WXPM__)
        #include "wx-2.8.10/os2/frame.h"
    #endif
#endif
