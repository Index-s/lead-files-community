...
// ----------------------------------------------------------------------------
    ...
    #include "wx-2.8.10/univ/statline.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/statline.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/statline.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/statline.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/statline.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/statline.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/statline.h"
#else // use generic implementation for all other platforms
    #include "wx-2.8.10/generic/statline.h"
#endif
