...
#include "wx-2.8.10/defs.h"        // for wxDEFAULT &c
#include "wx-2.8.10/fontenc.h"     // the font encoding constants
#include "wx-2.8.10/gdiobj.h"      // the base class
...
// include the real class declaration
    ...
    #include "wx-2.8.10/palmos/font.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/font.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/font.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/font.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/font.h"
#elif defined(__WXX11__)
    #include "wx-2.8.10/x11/font.h"
#elif defined(__WXMGL__)
    #include "wx-2.8.10/mgl/font.h"
#elif defined(__WXDFB__)
    #include "wx-2.8.10/dfb/font.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/font.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/font.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/font.h"
#endif
