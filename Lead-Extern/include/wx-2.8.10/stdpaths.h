...
protected:
    ...
    #include "wx-2.8.10/msw/stdpaths.h"
// We want CoreFoundation paths on both CarbonLib and Darwin (for all ports)
#elif defined(__WXMAC__) || defined(__DARWIN__)
    #include "wx-2.8.10/mac/corefoundation/stdpaths.h"
#elif defined(__OS2__)
    #include "wx-2.8.10/os2/stdpaths.h"
#elif defined(__UNIX__)
    #include "wx-2.8.10/unix/stdpaths.h"
#elif defined(__PALMOS__)
    #include "wx-2.8.10/palmos/stdpaths.h"
#else
