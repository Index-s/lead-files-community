...
#  include "wx-2.8.10/palmos/chkconf.h"
#elif defined(__WXWINCE__)
#  include "wx-2.8.10/msw/wince/chkconf.h"
#elif defined(__WXMSW__)
#  include "wx-2.8.10/msw/chkconf.h"
#elif defined(__WXMAC__)
#  include "wx-2.8.10/mac/chkconf.h"
#elif defined(__OS2__)
#  include "wx-2.8.10/os2/chkconf.h"
#elif defined(__WXMGL__)
#  include "wx-2.8.10/mgl/chkconf.h"
#elif defined(__WXDFB__)
#  include "wx-2.8.10/dfb/chkconf.h"
#elif defined(__WXMOTIF__)
#  include "wx-2.8.10/motif/chkconf.h"
#elif defined(__WXX11__)
#  include "wx-2.8.10/x11/chkconf.h"
#endif

#ifdef __WXUNIVERSAL__
#   include "wx-2.8.10/univ/chkconf.h"
#endif
