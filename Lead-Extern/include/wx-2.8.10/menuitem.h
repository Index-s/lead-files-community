...
#include "wx-2.8.10/object.h"  // base class
...
// ----------------------------------------------------------------------------
    ...
    #include "wx-2.8.10/univ/menuitem.h"
#elif defined(__WXPALMOS__)
    #include "wx-2.8.10/palmos/menuitem.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/menuitem.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/menuitem.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/menuitem.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/menuitem.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/menuitem.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/menuitem.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/menuitem.h"
#endif
