...
#include "wx-2.8.10/longlong.h"
#include "wx-2.8.10/event.h"
#include "wx-2.8.10/stopwatch.h" // for backwards compatibility
#include "wx-2.8.10/window.h"    // only for NewControlId()
...
// ----------------------------------------------------------------------------
    ...
    #include "wx-2.8.10/msw/timer.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/timer.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/timer.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/timer.h"
#elif defined(__WXX11__) || defined(__WXMGL__) || defined(__WXDFB__)
    #include "wx-2.8.10/generic/timer.h"
#elif defined (__WXCOCOA__)
    #include "wx-2.8.10/cocoa/timer.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/timer.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/timer.h"
#endif
