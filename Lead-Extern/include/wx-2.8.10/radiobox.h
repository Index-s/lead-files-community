...
private:
    ...
    #include "wx-2.8.10/univ/radiobox.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/radiobox.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/radiobox.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/radiobox.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/radiobox.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/radiobox.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/radiobox.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/radiobox.h"
#elif defined(__WXPALMOS__)
    #include "wx-2.8.10/palmos/radiobox.h"
#endif
