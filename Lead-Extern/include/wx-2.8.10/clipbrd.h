...
// ----------------------------------------------------------------------------
    ...
    #include "wx-2.8.10/msw/clipbrd.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/clipbrd.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/clipbrd.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/clipbrd.h"
#elif defined(__WXX11__)
    #include "wx-2.8.10/x11/clipbrd.h"
#elif defined(__WXMGL__)
    #include "wx-2.8.10/mgl/clipbrd.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/clipbrd.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/clipbrd.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/clipbrd.h"
#endif
