...
protected:
    ...
    #include "wx-2.8.10/univ/gauge.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/gauge95.h"
    #define wxGauge wxGauge95
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/gauge.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/gauge.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/gauge.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/gauge.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/gauge.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/gauge.h"
#endif
