...
*/
    ...
    #include "wx-2.8.10/msw/ole/dataform.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/dataform.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/dataform.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/dataform.h"
#elif defined(__WXX11__)
    #include "wx-2.8.10/x11/dataform.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/dataform.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/dataform.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/dataform.h"
#endif
...
#if defined(__WXMSW__)
    #include "wx-2.8.10/msw/ole/dataobj.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/dataobj.h"
#elif defined(__WXX11__)
    #include "wx-2.8.10/x11/dataobj.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/dataobj.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/dataobj.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/dataobj.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/dataobj.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/dataobj.h"
#endif
...
#if defined(__WXMSW__)
    #include "wx-2.8.10/msw/ole/dataobj2.h"

    // wxURLDataObject defined in msw/ole/dataobj2.h
#else // !__WXMSW__
    #if defined(__WXGTK20__)
        #include "wx-2.8.10/gtk/dataobj2.h"
    #elif defined(__WXGTK__)
        #include "wx-2.8.10/gtk1/dataobj2.h"
    #elif defined(__WXX11__)
        #include "wx-2.8.10/x11/dataobj2.h"
    #elif defined(__WXMOTIF__)
        #include "wx-2.8.10/motif/dataobj2.h"
    #elif defined(__WXMAC__)
        #include "wx-2.8.10/mac/dataobj2.h"
    #elif defined(__WXCOCOA__)
        #include "wx-2.8.10/cocoa/dataobj2.h"
    #elif defined(__WXPM__)
        #include "wx-2.8.10/os2/dataobj2.h"
    #endif
