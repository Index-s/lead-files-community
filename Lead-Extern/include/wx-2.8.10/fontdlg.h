...
#include "wx-2.8.10/defs.h"            // for wxUSE_FONTDLG

#if wxUSE_FONTDLG

#include "wx-2.8.10/dialog.h"          // the base class
#include "wx-2.8.10/cmndata.h"         // wxFontData
...
#define USE_NATIVE_FONT_DIALOG_FOR_MACOSX 0
    ...
    #include "wx-2.8.10/generic/fontdlgg.h"
    #define wxFontDialog wxGenericFontDialog
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/fontdlg.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/fontdlg.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/fontdlg.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/fontdlg.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/fontdlg.h"
#endif
