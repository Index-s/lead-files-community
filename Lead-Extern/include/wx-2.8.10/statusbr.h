...
// ----------------------------------------------------------------------------
    ...
    #include "wx-2.8.10/univ/statusbr.h"
#elif defined(__WXPALMOS__)
    #define wxStatusBarPalm wxStatusBar

    #include "wx-2.8.10/palmos/statusbr.h"
#elif defined(__WIN32__) && wxUSE_NATIVE_STATUSBAR
    #define wxStatusBar95 wxStatusBar

    #include "wx-2.8.10/msw/statbr95.h"
#elif defined(__WXMAC__)
    #define wxStatusBarMac wxStatusBar

    #include "wx-2.8.10/generic/statusbr.h"
    #include "wx-2.8.10/mac/statusbr.h"
#else
