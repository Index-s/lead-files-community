...
#include "wx-2.8.10/generic/filedlgg.h"
#elif defined(__WXMSW__)
#include "wx-2.8.10/msw/filedlg.h"
#elif defined(__WXMOTIF__)
#include "wx-2.8.10/motif/filedlg.h"
#elif defined(__WXGTK24__)
#include "wx-2.8.10/gtk/filedlg.h"     // GTK+ > 2.4 has native version
#elif defined(__WXGTK20__)
#define wxUSE_GENERIC_FILEDIALOG
#include "wx-2.8.10/generic/filedlgg.h"
#elif defined(__WXGTK__)
#include "wx-2.8.10/gtk1/filedlg.h"
#elif defined(__WXMAC__)
#include "wx-2.8.10/mac/filedlg.h"
#elif defined(__WXCOCOA__)
#include "wx-2.8.10/cocoa/filedlg.h"
#elif defined(__WXPM__)
#include "wx-2.8.10/os2/filedlg.h"
#endif
