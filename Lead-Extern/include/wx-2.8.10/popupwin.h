...
// include the real class declaration
    ...
    #include "wx-2.8.10/msw/popupwin.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/popupwin.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/popupwin.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/popupwin.h"
#elif defined(__WXX11__)
    #include "wx-2.8.10/x11/popupwin.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/popupwin.h"
#elif defined(__WXMGL__)
    #include "wx-2.8.10/mgl/popupwin.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/popupwin.h"
#else
