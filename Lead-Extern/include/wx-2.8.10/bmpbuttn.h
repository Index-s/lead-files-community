...
inline void wxBitmapButtonBase::SetLabel(const wxBitmap& bitmap)
{
    ...
    #include "wx-2.8.10/univ/bmpbuttn.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/bmpbuttn.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/bmpbuttn.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/bmpbuttn.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/bmpbuttn.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/bmpbuttn.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/bmpbuttn.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/bmpbuttn.h"
#endif
