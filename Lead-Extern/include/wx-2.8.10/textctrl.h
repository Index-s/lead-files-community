...
#include "wx-2.8.10/control.h"         // the base class
#include "wx-2.8.10/dynarray.h"        // wxArrayInt
#include "wx-2.8.10/gdicmn.h"          // wxPoint
...
// ----------------------------------------------------------------------------
    ...
    #include "wx-2.8.10/x11/textctrl.h"
#elif defined(__WXUNIVERSAL__)
    #include "wx-2.8.10/univ/textctrl.h"
#elif defined(__SMARTPHONE__) && defined(__WXWINCE__)
    #include "wx-2.8.10/msw/wince/textctrlce.h"
#elif defined(__WXMSW__)
    #include "wx-2.8.10/msw/textctrl.h"
#elif defined(__WXMOTIF__)
    #include "wx-2.8.10/motif/textctrl.h"
#elif defined(__WXGTK20__)
    #include "wx-2.8.10/gtk/textctrl.h"
#elif defined(__WXGTK__)
    #include "wx-2.8.10/gtk1/textctrl.h"
#elif defined(__WXMAC__)
    #include "wx-2.8.10/mac/textctrl.h"
#elif defined(__WXCOCOA__)
    #include "wx-2.8.10/cocoa/textctrl.h"
#elif defined(__WXPM__)
    #include "wx-2.8.10/os2/textctrl.h"
#endif
